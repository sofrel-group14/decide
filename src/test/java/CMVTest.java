...
public class CMVTest {
  @Test
  /**
   * @Test gives True Boolean Value based on Test It Test that it can find 3
   *       points in three different quadrants It Test that it can skips the first
   *       data points to find the next 3 consecitive data points
   **/
